  ...
  return (
    <div className="page-stake container">
      ...
      <div className="list-segments">
        ...
        <div className={cx("segment-item segment-stake", segment === 'stake' && 'active')} onClick={() => setSegment('stake')}>Stake</div>
        <div className={cx("segment-item segment-unstake", segment === 'unstake' && 'active')} onClick={() => setSegment('unstake')}>Unstake</div>
      </div>
      <div className="stake-container">
        <div className="content-form stake-form">
          {
            segment === 'stake' ? (
              <FormStake />
            ) : (
...
export const FormTooltip = ({message}) => (
  <div className="stake-tooltip">{message}</div>
)